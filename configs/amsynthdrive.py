...
_CN.percostformer3.amodal_layers = 8
...
# decoder
_CN.percostformer3.decoder_depth = 4  # was 12
_CN.percostformer3.critical_params = [
    "vert_c_dim",
    "encoder_depth",
